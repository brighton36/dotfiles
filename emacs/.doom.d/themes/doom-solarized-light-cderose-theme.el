...
(def-doom-theme doom-solarized-light-cderose
  ...
  ((bg         '("#FDF6E3" "#FDF6E3" "white"        ))
   ...
   ;; NOTE: This is the only real change in the cderose-theme. We just set this to bg
   (bg-alt     '("#FDF6E3" "#FDF6E3" "white"        ))
   ...
   (base2      '("#EEE8D5" "#FCF7E8" "brightblack"  ))
